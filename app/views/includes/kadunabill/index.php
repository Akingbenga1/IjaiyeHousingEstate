...
<div id="header">
	...
	<div class="container">
		...
		<div class="col-lg-8 col-md-8 hiddem-sm hidden-xs">
            <div id="side-head">
                <h2 align="right">ELECTRICITY <span style="color:#70ac2b">BILL</span></h2>
                <p align="right">Pay/Manage your account</p>
            </div>
		</div>
    ...
    <div id="base">
        ...
        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12" style="margin-bottom:2%">
			
            <div class="box-flex" style="float:left">
               <p align="center"> <img src="img/address-icon.png"></p>
            </div>
            <div  class="box-flex" style="float:left; width:300px">
               <h3>Tunde James </h3>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="num-box">
                        ...
                        <span class="num1"> Bill#: <b> 200</b></span>
                        <div class="clear-fix"></div>
                        <span class="num1"> Due Date: <b>20 March 2017</b></span>
                    </div>
	...
	<div class="container">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            ...
            <div id="profile">
               ...
               <Span class= "glyphicon glyphicon-th-list" style="font-size:56px; float:left; padding-right:2%"></Span>
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
            ...
            <div id="table-1">
                ...
                <h2 align="right">BILL SUMMARY</h2>
                
                <table class="table table-hover table-bordered" style="padding:2%">
  <thead style="background: #d5eeb9;">
  ...
  <tbody>
    ...
    <td >Cell</td>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <h2 style="font-size:28px; margin-top:10%">Please Pay bill before last due date</h2>
            </div>
            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                <div id="tot-box">
